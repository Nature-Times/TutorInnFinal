    ...
    <div class="tutorBox">
        <div class="profile">
            <div class="profileBox">
                ...
                <img src="<?php echo e($tutor->mahasiswa->profilePicture); ?>" class="iconProfile">
                <?php else: ?>
                <img src="<?php echo e(asset('Element/profile Icon.png')); ?>" class="iconProfile">
                <?php endif; ?>
            </div>
        </div>
        <div class="tutorDesc">
...
<?php /**PATH C:\Users\62822\Herd\TutorInn3-main\resources\views/profiletutor.blade.php ENDPATH**/ ?>