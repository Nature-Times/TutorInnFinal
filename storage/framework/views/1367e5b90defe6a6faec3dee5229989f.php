        ...
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center">
                <div class="col-md-3 text-center">
                    <img src="<?php echo e(asset("/Element/Footer Elements/TutorInnFooter.png")); ?>" 
                         alt="TutorInn Logo" 
                ...
                <div class="col-md-3 text-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <img src="<?php echo e(asset("/Element/Footer Elements/CP.png")); ?>" 
                             alt="CP Icon" 
                             class="footer-icon me-2">
                        <img src="<?php echo e(asset("/Element/Footer Elements/Call.png")); ?>" 
                             alt="Call Icon" 
                             class="footer-icon">
                    </div>
                </div>
                ...
                <div class="col-md-3 text-center d-flex flex-column align-items-center">
                    ...
                    <img src="<?php echo e(asset("/Element/Footer Elements/Location.png")); ?>" 
                         alt="Location Icon" 
                ...
                <div class="col-md-3 text-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <img src="<?php echo e(asset("/Element/Footer Elements/InstaFooter.png")); ?>" 
                             alt="Instagram Icon" 
                             class="footer-icon social-icon me-2"
                             style="background-color: orange; border-radius: 50%; margin: 1vw 0.5vw; height: 4vw; width: 4vw;">
                        <img src="<?php echo e(asset("/Element/Footer Elements/FacebookFooter.png")); ?>" 
                             alt="Facebook Icon" 
                             class="footer-icon social-icon me-2"
                             style="background-color: orange; border-radius: 50%; margin: 1vw 0.5vw; height: 4vw; width: 4vw;">
                        <img src="<?php echo e(asset("/Element/Footer Elements/YouTubeFooter.png")); ?>" 
                             alt="YouTube Icon" 
                             class="footer-icon social-icon me-2"
                             style="background-color: orange; border-radius: 50%; margin: 1vw 0.5vw; height: 4vw; width: 4vw;">
                        <img src="<?php echo e(asset("/Element/Footer Elements/WhatsAppFooter.png")); ?>" 
                             alt="WhatsApp Icon" 
                             class="footer-icon social-icon me-2"
                             style="background-color: orange; border-radius: 50%; margin: 1vw 0.5vw; height: 4vw; width: 4vw;">
                        <img src="<?php echo e(asset("/Element/Footer Elements/TikTokFooter.png")); ?>" 
                             alt="TikTok Icon" 
...
<?php /**PATH C:\Users\62822\Herd\TutorInn3-main\resources\views/footer.blade.php ENDPATH**/ ?>