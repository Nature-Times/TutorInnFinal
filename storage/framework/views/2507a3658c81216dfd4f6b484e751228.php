...
<body>
    ...
    <div class="container-fluid p-3 position-fixed w-100" style="top: 5%; z-index: 100;">
        <div class="d-flex align-items-center justify-content-between">
            <!-- Circle Header -->
            <img src="<?php echo e(asset("/Element/EllipseHeader.png")); ?>" class="rounded-circle shadow-lg" 
            ...
            <div class="headerBox d-flex align-items-center" 
                ...
                <!-- Logo -->
                <div class="logoBox">
                    <img src="<?php echo e(asset("/Element/Logo Navbar.png")); ?>" class="iconLogo me-2" style="height: 5vw; margin-top: 3%; margin-left: 5%;">
                </div>
                ...
                <div class="dropdown" style="margin-right: 2%;">
                    ...
                    <?php else: ?>
                    <img src="<?php echo e(asset('/Element/profile Icon.png')); ?>" 
                         class="rounded-circle shadow-sm dropdown-toggle" 
                         style="width: 3.5vw; height: 3.5vw; cursor: pointer;" 
                         id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                    <?php endif; ?>
...
<?php /**PATH C:\Users\62822\Herd\TutorInn3-main\resources\views/header.blade.php ENDPATH**/ ?>