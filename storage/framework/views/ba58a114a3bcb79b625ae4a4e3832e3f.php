  ...
  <body>
    ...
    <div class="buttons-line">
      <button class="back-button">
        <a href="<?php echo e(route('homepage')); ?>"><img src="<?php echo e(asset('Element/arrow.png')); ?>" alt="" /></a>
      </button>
    </div>
                ...
                <div class="tutor-items">
                    <center>
                        <a href="<?php echo e(route('view_profileTutor', ['name' => $tutor->name, 'subject' => $subject])); ?>" style="text-decoration: none; color: black;">
                            <?php if($tutor->mahasiswa->profilePicture): ?>
                            <img src="<?php echo e($tutor->mahasiswa->profilePicture); ?>" class="profileOthers">
                            <?php else: ?>
                            <img src="<?php echo e(asset('Element/profile Icon.png')); ?>" class="profileOthers">
                            <?php endif; ?>
...
<?php /**PATH C:\Users\62822\Herd\TutorInn3-main\resources\views/pickTutor.blade.php ENDPATH**/ ?>