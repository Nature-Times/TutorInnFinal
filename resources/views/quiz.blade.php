  ...
  <body>
    ...
    <div class="containerBox">
      ...
      <div class="quiz-paper" style="background-color: #f1dec9; border-radius: 20px; padding: 3%;">
        ...
        <br />
        <p class="quiz-question" style="font-size: 1.5vw; font-family: 'Kameron';">{{ $test->question1 }}</p>
        <br />
        <p class="quiz-question" style="font-size: 1.5vw; font-family: 'Kameron';">{{ $test->question2 }}</p>
        <br />
        <br /><br />

        <h3>Submit video:</h3>
        <form action="{{ route('quiz.video') }}" method="POST" enctype="multipart/form-data">
            @csrf
